...
import cn.edu.xmu.ooad.order.order.controller.FreightController;
import cn.edu.xmu.ooad.order.order.mapper.FreightModelPoMapper;
import cn.edu.xmu.ooad.order.order.mapper.PieceFreightModelPoMapper;
import cn.edu.xmu.ooad.order.order.mapper.WeightFreightModelPoMapper;
import cn.edu.xmu.ooad.order.order.model.bo.freight.FreightModel;
import cn.edu.xmu.ooad.order.order.model.bo.freight.impl.PieceFreightModelRule;
import cn.edu.xmu.ooad.order.order.model.bo.freight.impl.WeightFreightModelRule;
